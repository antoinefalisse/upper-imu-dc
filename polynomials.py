                        ...
                        for nq[4] in range(nq5_s + 1):
                            ...
                            for nq[5] in range(nq6_s + 1):
                                if (dimension < 7):
                                    ...
                                    nq7_s = order - nq[0] - nq[1] - nq[2] - nq[3] - nq[4] - nq[5]
                                for nq[6] in range(nq7_s + 1):
                                    if (dimension < 8):
                                        nq8_s = 0
                                    else:
                                        nq8_s = order - nq[0] - nq[1] - nq[2] - nq[3] - nq[4] - nq[5] - nq[6]
                                    for nq[7] in range(nq8_s + 1):
                                        if (dimension < 9):
                                            nq9_s = 0
                                        else:
                                            nq9_s = order - nq[0] - nq[1] - nq[2] - nq[3] - nq[4] - nq[5] - nq[6] - nq[7]
                                        for nq[8] in range(nq9_s + 1):                         
                                            NCoeff += 1
                        ...
                        for nq[4] in range(nq5_s + 1):  
                            ...
                            for nq[5] in range(nq6_s + 1):
                                if (self.dimension < 7):
                                    ...
                                    nq7_s = self.order - nq[0] - nq[1] - nq[2] - nq[3] - nq[4] - nq[5]
                                for nq[6] in range(nq7_s + 1):
                                    if (self.dimension < 8):
                                        nq8_s = 0
                                    else:
                                        nq8_s = self.order - nq[0] - nq[1] - nq[2] - nq[3] - nq[4] - nq[5] - nq[6]
                                    for nq[7] in range(nq8_s + 1):
                                        if (self.dimension < 9):
                                            nq9_s = 0
                                        else:
                                            nq9_s = self.order - nq[0] - nq[1] - nq[2] - nq[3] - nq[4] - nq[5] - nq[6] - nq[7]
                                        for nq[8] in range(nq9_s + 1):
                                            valueP = 1
                                        ...
                                        for nq[8] in range(nq9_s + 1):
                                            if (derivComponent == 0):
                                                ...
                                                for d in range(self.dimension):
                                                    ...
                                                    valueP *= pow(x[d], nq[d])
                                                value += valueP * self.coefficients[coeff_nr]                                                
                                            elif (derivComponent == 6):
                                                nqNonNegative = nq[6] - 1
                                                if (nqNonNegative < 0):
                                                    nqNonNegative = 0
                                                valueP = nq[6] * pow(x[6], nqNonNegative);
                                                for d in range(self.dimension):
                                                    if (d == derivComponent):
                                                        continue
                                                    valueP *= pow(x[d], nq[d])
                                                value += valueP * self.coefficients[coeff_nr]                                                
                                            elif (derivComponent == 7):
                                                nqNonNegative = nq[7] - 1
                                                if (nqNonNegative < 0):
                                                    nqNonNegative = 0
                                                valueP = nq[7] * pow(x[7], nqNonNegative);
                                                for d in range(self.dimension):
                                                    if (d == derivComponent):
                                                        continue
                                                    valueP *= pow(x[d], nq[d])
                                                value += valueP * self.coefficients[coeff_nr]                                                
                                            elif (derivComponent == 8):
                                                nqNonNegative = nq[8] - 1
                                                if (nqNonNegative < 0):
                                                    nqNonNegative = 0
                                                valueP = nq[8] * pow(x[8], nqNonNegative);
                                                for d in range(self.dimension):
                                                    if (d == derivComponent):
                                                        continue
                                                    valueP *= pow(x[d], nq[d])

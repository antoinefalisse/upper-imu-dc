...
class bounds:  
    ...
    def getBoundsVelocity(self):
        ...
        upperBoundsVelocity_all['ground_thorax_rot_x'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['ground_thorax_rot_y'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['ground_thorax_rot_z'] = [250 * np.pi / 180]
        ...
        upperBoundsVelocity_all['clav_prot'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['clav_elev'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['scapula_abduction'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['scapula_elevation'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['scapula_upward_rot'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['scapula_winging'] = [250 * np.pi / 180]        
        upperBoundsVelocity_all['plane_elv'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['shoulder_elv'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['axial_rot'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['elbow_flexion'] = [250 * np.pi / 180]
        upperBoundsVelocity_all['pro_sup'] = [250 * np.pi / 180]
        
        lowerBoundsVelocity_all['ground_thorax_rot_x'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['ground_thorax_rot_y'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['ground_thorax_rot_z'] = [-250 * np.pi / 180]
        ...
        lowerBoundsVelocity_all['clav_prot'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['clav_elev'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['scapula_abduction'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['scapula_elevation'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['scapula_upward_rot'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['scapula_winging'] = [-250 * np.pi / 180]        
        lowerBoundsVelocity_all['plane_elv'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['shoulder_elv'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['axial_rot'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['elbow_flexion'] = [-250 * np.pi / 180]
        lowerBoundsVelocity_all['pro_sup'] = [-250 * np.pi / 180]

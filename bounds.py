...
class bounds:  
    ...
    def getBoundsPositionConservative(self):
        ...
        upperBoundsPosition_all['plane_elv'] = [75 * np.pi / 180]
        upperBoundsPosition_all['shoulder_elv'] = [95 * np.pi / 180]
        upperBoundsPosition_all['axial_rot'] = [75 * np.pi / 180]
        upperBoundsPosition_all['elbow_flexion'] = [20 * np.pi / 180]
        upperBoundsPosition_all['pro_sup'] = [50 * np.pi / 180]
        ...
        lowerBoundsPosition_all['scapula_upward_rot'] = [5 * np.pi / 180]
        lowerBoundsPosition_all['scapula_winging'] = [-20 * np.pi / 180]        
        lowerBoundsPosition_all['plane_elv'] = [-45 * np.pi / 180]
        lowerBoundsPosition_all['shoulder_elv'] = [-5 * np.pi / 180]
        lowerBoundsPosition_all['axial_rot'] = [-40 * np.pi / 180]
        lowerBoundsPosition_all['elbow_flexion'] = [-20 * np.pi / 180]
        lowerBoundsPosition_all['pro_sup'] = [10 * np.pi / 180]
